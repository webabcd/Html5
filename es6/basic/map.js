...
console.log(`a:${myMap.get("a")}, b:${myMap.get("b")}, c:${myMap.get("c")}, size:${myMap.size}`);
...
console.log(new Map([["a", "aaa"], ["b", "bbb"], ["c", "ccc"]]));


// map 对象转数组
console.log(Array.from(new Map([["a", "aaa"], ["b", "bbb"], ["c", "ccc"]])));
// 结果为 [["a", "aaa"], ["b", "bbb"], ["c", "ccc"], length: 3]


// 实例化 map 对象时，可以指定数据来源的 map 对象（这个相当于 map 对象的克隆）
let myMap1 = new Map([["a", "aaa"], ["b", "bbb"], ["c", "ccc"]]);
let myMap2 = new Map(myMap1);
console.log(`a:${myMap2.get("a")}, b:${myMap2.get("b")}, c:${myMap2.get("c")}`);
